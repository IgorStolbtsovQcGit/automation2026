...
test.describe('Fuel Expenses tests', () => {
    ...
    test('Validation - more 9999 liters', async ({ app }) => {
        // const newMileage = String(faker.number.int({ min: 1000, max: 3000 }));
        // const numberOfLiters = String(faker.number.int({ min: 10000, max: 500000 }));
        // const totalCost = String (faker.number.int({ min: 10, max: 500 }));
    ...
    test('Validation - more 1000000 total cost', async ({ app }) => {
        // const newMileage = String(faker.number.int({ min: 1000, max: 3000 }));
        // const numberOfLiters = String(faker.number.int({ min: 10, max: 50 }));
        // const totalCost = String (faker.number.int({ min: 10000001, max: 100000000 }));
